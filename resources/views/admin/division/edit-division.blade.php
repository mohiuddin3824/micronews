            ...
            <div class="col-12">
                ...
                <div class="box">
                   ...
                   <div class="box-body">
                    ...
                    <form class="forms-sample" action="{{route('update.divison')}}" method="POST">
                        @csrf
                        <input type="hidden" name="id" value="{{$division->id}}">
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="division_slug" value="{{$division->division_slug}}">
                          </div>
                          <button type="submit" class="btn btn-primary mr-2">{{ __('Update Division') }}</button>
                      </form>
                   <!-- /.box-body -->
                </div>
                 <!-- /.box -->      
