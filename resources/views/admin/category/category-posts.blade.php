                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">{{ __('All Posts From: ') }} <span class="pl-1">{{ $category->category_name }}</span></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                ...
                                <table id="example6" class="table table-bordered table-striped" style="width:100%">
                                    ...
                                    <tbody>
                                        @if ($role == 1 || $role == 2)
                                            ...
                                            @endif
                                        @else
                                            @if ($AuthCatWiseNews->count() > 0)
                                                @foreach ($AuthCatWiseNews as $post)
