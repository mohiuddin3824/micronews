                         ...
                         <div class="d-inline-block align-items-center">
                             <nav>
                                 <ol class="breadcrumb">
                                     ...
                                     <li class="breadcrumb-item" aria-current="page">{{ __('Edit Post') }}</li>
                                 </ol>
                             </nav>
                         </div>
                     </div>
                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-4 text-right">
                                         <a href="{{ route('all.posts') }}"
                                             class="btn btn-success">{{ __('Post list') }}</a>
                                     </div>
                                 </div>
                             </div>
                         </div>
                         ...
                         <form action="{{ route('update.post') }}" method="POST" enctype="multipart/form-data">
                             ...
                             <div class="row">
                                     ...
                                     <div class="box bl-3 border-primary">
                                         <div class="box-body">
                                             <div class="form-group">
                                                 ...
                                                 <input type="text" class="form-control" name="post_uper_title" value="{{ $editPost->post_uper_title }}">
                                             </div>
                                             <div class="form-group">
                                                 <label for="post_title">{{ __('Post Title') }}</label>
                                                 <input type="text" class="form-control" name="post_title" placeholder="Post Title" value="{{ $editPost->post_title }}">

                                             </div>
                                             <div class="form-group">
                                                 <label for="post_sub_title">{{ __('Post Sub Title') }}</label>
                                                 <input type="text" class="form-control" name="post_sub_title"
                                                     placeholder="Post Sub Title" value="{{ $editPost->post_sub_title }}">
                                             </div>

                                             <div class="form-group">
                                                 <textarea id="editpost_content" name="post_details" rows="20" cols="80">
                                                    {{ $editPost->post_details }}
                                                </textarea>
                                             </div>
                                             <div class="form-group">
                                                 <label class="form-control-label">{{ __('Post Tags') }}</label>
                                                 <input type="text" class="w-100" id="tagnames" name="tags[]"
                                                     data-role="tagsinput" value="@foreach ($editPost->tags as $tags){{ $tags->name . ',' }}@endforeach">
                                             ...
                                             <div class="box-body" style="display: block;">
                                                 <div class="form-group">
                                                     ...
                                                     <input type="text" class="form-control" name="post_slug"
                                                         value="{{ $editPost->post_slug }}" placeholder="Post Slug">
                                                 </div>
                                                 <div class="callout">
                                                     <div class="form-group">
                                                         <label for="seo_title">{{ __('Post SEO Title') }}</label>
                                                         <input type="text" name="seo_title"
                                                             value="{{ $editPost->seo_title }}" class="form-control"
                                                 ...
                                                 <div class="box-body" style="display: block;">
                                                     <div class="form-group">
                                                         ...
                                                         <textarea rows="5" cols="5" name="seo_descp" class="form-control"
                                                             placeholder="Meta Description">{{ $editPost->seo_descp }}</textarea>
                                                     </div>
                                                 </div>
                                             </div>
                                         </div>
                                 ...
                                 <div class="col-md-3">
                                     ...
                                     <div class="box bl-3 border-primary">
                                         <div class="box-header">
                                             <label for="repoter_name">{{ __('Edit Reporter Name') }}</label>
                                         </div>
                                         <div class="box-body">
                                             <div class="form-group">
                                                 <input type="text" class="form-control" name="repoter_name" value="{{ $editPost->repoter_name }}">
                                             </div>
                                         </div>
                                     </div>
                                     <div class="box bl-3 border-primary">
                                         <div class="box-body">
                                             <div class="form-group">
                                                 ...
                                                 <select class="js-example-basic-single" name="division_id"
                                                     style="width:100%; padding: 8px 2px; background:#2a3038; color:#fff">
                                                     <option disabled selected>{{ __('Select Division') }}</option>
                                                     @foreach ($postDivisions as $div)

                                                         <option value="{{ $div->id }}"
                                                             {{ $div->id == $editPost->division_id ? 'selected' : '' }}>
                                             ...
                                             <div class="form-group">
                                                 ...
                                                 <select class="js-example-basic-single" id="district_id" name="district_id"
                                                     style="width:100%; padding:8px 2px;">
                                                     @foreach ($post_dist as $dist)
                                                         <option value="{{ $dist->id }}"
                                                             {{ $dist->id == $editPost->district_id ? 'selected' : '' }}>
                                             ...
                                             <div class="form-group">
                                                 ...
                                                 <select class="js-example-basic-single" name="category_id"
                                                     ...
                                                     @foreach ($postCats as $cat)
                                                         ...
                                                         <option value="{{ $cat->id }}"
                                                             {{ $cat->id == $editPost->category_id ? 'selected' : '' }}>
                                     ...
                                     <div class="box bl-3 border-primary">
                                         ...
                                         <div class="box-body">
                                             ...
                                             <div>
                                                 <label for="image">{{ __('Post Thumbnail') }}</label>
                                                 <img id="mainThmb" src="{{ asset($editPost->post_thumbnail) }}"
                                                     class="img-thumbnail">
                                                 <input type="hidden" name="oldimage"
                                                     value="{{ $editPost->post_thumbnail }}">
                                             </div>
                                             <div class="form-group">
                                                 <h4>{{ __('Image Caption') }}</h4>
                                                 <span class="badge badge-info">{{ __('Optional') }}</span>
                                                 <textarea name="thumbnail_caption"
                                                     class="form-control">{{ $editPost->thumbnail_caption }}</textarea>
                                             </div>
                                             <div class="form-group">
                                                 ...
                                                 <input type="text" name="thumbnail_alt"
                                                     value="{{ $editPost->thumbnail_alt }}" class="form-control">
                                             </div>
                                         </div>
                                     </div>
                                 </div>
                                     ...
                                     <div class="card">
                                         <div class="card-body text-center">
                                             <button class="btn btn-lg btn-success"
                                                 style="font-size: 20px">{{ __('Update') }}</button>
                                         </div>
                                     </div>
                                 </div>
                             </div>
